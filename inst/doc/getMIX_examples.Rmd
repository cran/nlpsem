...
## Example 2: Fit reduced bilinear spline LGCMs with three latent classes to analyze the heterogeneity in the development of mathematics skills. Four distinct models will be created in this example: (1) a growth mixture model without any covariates, (2) a growth mixture model incorporating only cluster time-invariant covariates (TICs), (3) a growth mixture model integrating only growth TICs, (4) a growth mixture model that includes both cluster and growth TICs.
```{r, message = FALSE, eval = FALSE}
paraBLS_LGCM.r <- c(
...
## Example 3: Fit reduced bilinear spline bivariate LGCMs with three latent classes to analyze the heterogeneity in the co-development of reading and mathematics skills.
```{r, message = FALSE, eval = FALSE}
paraBLS_PLGCM.r <- c(
